package com.maixuanviet.atomikos.spring.jpa.order;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.maixuanviet.atomikos.spring.jpa.order", entityManagerFactoryRef = "orderEntityManager", transactionManagerRef = "transactionManager")
public class OrderConfig {
    ...
    public EntityManagerFactory orderEntityManager() {
        ...
        factory.setPackagesToScan("com.maixuanviet.atomikos.spring.jpa.order");
