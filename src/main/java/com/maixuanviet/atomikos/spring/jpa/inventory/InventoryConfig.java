package com.maixuanviet.atomikos.spring.jpa.inventory;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.maixuanviet.atomikos.spring.jpa.inventory", entityManagerFactoryRef = "inventoryEntityManager", transactionManagerRef = "transactionManager")
public class InventoryConfig {
    ...
    public EntityManagerFactory inventoryEntityManager() {
        ...
        factory.setPackagesToScan("com.maixuanviet.atomikos.spring.jpa.inventory");
